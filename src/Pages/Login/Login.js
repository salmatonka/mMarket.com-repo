...
const Login = () => {
  ...
  const handleGoogleLogin =() =>{
    ...
    return (
		<div className='h-[800px] bg-violet-200 flex justify-center items-center'>
		<div className=''>
  ...
  <div className="flex items-center pt-4 space-x-1">
	...
	<p className=" pb-4 text-xs text-center sm:px-6 dark:text-gray-400">Don't have an account?
		<Link to='/signUp' rel="noopener noreferrer" className="underline text-violet-400 font-bold">Sign up</Link>
	</p>



  <input type="submit" value='Login' placeholder="Login" className=" text-white btn  w-full bg-violet-400 max-w-xs" />
